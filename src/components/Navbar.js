...
const Navbar = () => {
  ...
  return (
    <div className='w-screen h-[80px] z-10 bg-zinc-200 fixed drop-shadow-lg'>
        <div className='md:px-[100px] flex justify-between items-center w-full h-full'>
            <div className='flex items-center'>
                ...
                <ul className='hidden md:flex justify-content content-center'>
                
                    <li><Link  to="home"  smooth={true} duration={500}>Home</Link></li>
                    <li><Link  to="about"  smooth={true} offset={-200} duration={500}>About</Link></li>
                    <li><Link  to="support"  smooth={true} offset={-50} duration={500}>Who We Are</Link></li>
                    {/* <li><Link  to="platforms"  smooth={true} offset={-100} duration={500}>Platforms</Link></li>npm  */}
